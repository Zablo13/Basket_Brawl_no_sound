...
func drop():#P!
	...
	if Input.is_action_just_pressed("drop2") and held == true: #Gegen sofortigen Konter bei Ballabgabe wird Parry blockiert
		if Input.is_action_pressed("move_left2") and held == true: #P! left / right
			off()
...
func toss():#P!
	...
	if Input.is_action_pressed("punch2") and held == true and can_toss == true: #Schmetter hinten
		if Input.is_action_pressed("move_left2"): #P! rechts / links
...
func fire():
	if Input.is_action_pressed("move_down2"):
		p1 = true
	if Input.is_action_pressed("move_right2") and p1 == true: #P! R/L
		p1 = false
		p2 = true
	if Input.is_action_just_released("move_down2") and Input.is_action_pressed("move_right2") and p2 == true and can_punch == true:#P! R/L
		p2 = false
		p3 = true
